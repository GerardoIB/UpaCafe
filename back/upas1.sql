...
CREATE TABLE `detalle_pedido_ingredientes` (
  ...
  KEY `detalle_pedido_ingredientes_ibfk_1` (`detalle_pedido_id`),
  CONSTRAINT `detalle_pedido_ingredientes_ibfk_1` FOREIGN KEY (`detalle_pedido_id`) REFERENCES `detalle_pedidos` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `detalle_pedidos` (
  ...
  KEY `detalle_pedidos_ibfk_1` (`pedido_id`),
...
INSERT INTO `pedidos` VALUES (1,3,'2025-10-24 13:42:13',NULL,1000.00),(2,3,'2025-10-24 13:43:11',NULL,1000.00),(3,3,'2025-10-24 13:43:18',NULL,1000.00),(4,3,'2025-10-24 13:43:27',NULL,1000.00),(5,3,'2025-10-24 13:44:01',NULL,1000.00),(6,3,'2025-10-24 13:48:16',NULL,1000.00);
...
CREATE TABLE `tickets` (
  ...
  PRIMARY KEY (`id`),
  KEY `tickets_ibfk_1` (`pedido_id`),
  CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES (3,'Gerardo','gerardoib@outlok.com','$2b$10$tZhJifl6uQzpzxQrJtcvJO6ogWWLgalB6pC03ip.hBJ1vvl0Y5wnu',3,'7121895039',0,NULL,NULL,NULL),(4,'Jose david','jose123@gmail.com','$2b$10$aIomR3CdNqEZ9EViYAK2/ehh1A1/M.4IOCra8cknr5rP8F2RsXBnm',3,'1234567890',0,NULL,NULL,NULL),(19,'Gerardo Iglesias Becerril','gerardoib@outlook.com','$2b$10$enbY0YnaKpO9iKbGY7fX4.qffO7TsIN9nAbuFocYXZMXLJTcQ2z7S',1,'7121895039',0,'efcf33395b936fdecff69ace18607d43ff7c7e8786cca4ebf11838c2bd380557','463480','2025-10-28 15:09:50'),(34,'Gerardo Iglesias Becerril','gerarib9@gmail.com','$2b$10$dt8IvSLXyriu/FzP9sYYC.F5ZSpICvzxaTm4UAv9hJxF306Ni/KC6',2,'7121895039',1,'0362e07e27618b711f63b289c7c74db224f20a4d9db817da124d143d5d2d69c4','645213','2025-10-31 14:08:02');
...
-- Dump completed on 2025-10-31 13:19:44
